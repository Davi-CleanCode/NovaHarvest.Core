...
public sealed class SeedData { public string SeedItemId{get;} public string CropItemId{get;} public int GrowthDays{get;} public int WaterRequiredPerDay{get;} public int HarvestAmount{get;}
